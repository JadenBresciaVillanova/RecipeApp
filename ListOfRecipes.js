...
const ListOfRecipes = ({ navigation}) => {

    const recipes = [
      {recipeName: "Good Old-Fashioned Pancakes", recipeDescription: "I found this pancake recipe in my Grandma's recipe book. Judging from the weathered look of this recipe card, this was a family favorite."},
    ...
    const [listData] = useState(recipes);    
    const onPress = () => navigation.navigate("Recipe");
